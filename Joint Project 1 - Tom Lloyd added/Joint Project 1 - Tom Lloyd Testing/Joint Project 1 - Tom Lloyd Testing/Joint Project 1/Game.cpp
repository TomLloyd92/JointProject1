...
// This function updates the game world
{
	...
	{
		if (bullet.bulletFired == false)
		{
			bullet.getPlayerDirection(Link.getDirection());
			bullet.getPlayerPosition(Link.getPosition());
			bullet.fired();
		}
	}
	...
	Knight.getPlayerPosition(Link.getPosition());

	//bullet.setPosition(Link.getPosition());
	bullet.update();
...
// This function draws the game world
{
	...
	window.draw(Link.draw());
	window.draw(Skeleton.draw());
